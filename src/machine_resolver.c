...
{	
	...
	servers_from_file("./lists/sousdomaine/fr", sousdomaine_fr, NB_SOUS_DOMAINES/2); //pour lui
	printf("\n");
	...
	servers_from_file("./lists/sousdomaine/com", sousdomaine_com, NB_SOUS_DOMAINES/2); //pour lui
	printf("\n");
	for(int i = 0; i < NB_SOUS_DOMAINES/2; i++){
	...
	servers_from_file("./lists/machine/a.fr", machine_a_fr, NB_MACHINES/4);
	printf("\n");
	...
	servers_from_file("./lists/machine/b.fr", machine_b_fr, NB_MACHINES/4);
	printf("\n");
	for(int i = 0; i < NB_MACHINES/4; i++){
	...
	servers_from_file("./lists/machine/a.com", machine_a_com, NB_MACHINES/4);
	printf("\n");
	for(int i = 0; i < NB_MACHINES/4; i++){
	...
	servers_from_file("./lists/machine/b.com", machine_b_com, NB_MACHINES/4);
	printf("\n");
	for(int i = 0; i < NB_MACHINES/4; i++){
